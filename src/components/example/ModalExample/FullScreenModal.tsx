        ...
        <div className="fixed top-0 left-0 flex flex-col justify-between w-full h-screen p-6 overflow-x-hidden overflow-y-auto bg-white dark:bg-gray-900 lg:p-10">
          <div>
            ...
            <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
              This full-screen modal is meant for longer content, multi-step
              flows, or forms that need more space.
            </p>
            <p className="mt-5 text-sm leading-6 text-gray-500 dark:text-gray-400">
              Replace this placeholder copy with your actual instructions or
              details. Keep it concise and actionable.
            </p>
            <p className="mt-5 text-sm leading-6 text-gray-500 dark:text-gray-400">
              Add supporting information here if needed.
            </p>
          </div>
