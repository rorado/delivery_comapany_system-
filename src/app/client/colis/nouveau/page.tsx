...
// Every city has an explicit price (default unless overridden).
const CITY_DELIVERY_FEES: Record<string, DeliveryFees> = (() => {
  ...
  for (const [city, fees] of Object.entries(overrides)) {
    all[city] = fees;
  }
...
export default function ClientNouveauColisPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push("/client/colis/liste");
    } finally {
      setIsSaving(false);
    }
  };
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            ...
            <textarea
              ...
              placeholder="Adresse *"
              className="mt-1 min-h-[44px] h-11 w-full rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm shadow-theme-xs focus:outline-none focus:ring-2 focus:ring-brand-500/10 focus:border-brand-300 dark:bg-gray-900 dark:text-white/90 dark:border-gray-700"
            />
          </div>
          ...
          <div className="lg:col-span-3">
            ...
            <textarea
              ...
              className="mt-1 min-h-[44px] w-full rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm shadow-theme-xs focus:outline-none focus:ring-2 focus:ring-brand-500/10 focus:border-brand-300 dark:bg-gray-900 dark:text-white/90 dark:border-gray-700"
            />
          </div>
