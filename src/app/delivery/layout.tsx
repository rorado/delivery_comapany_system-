...
const deliveryNavItems = [
  { name: "Tableau de bord", path: "/delivery", icon: <BoxIconLine className="w-5 h-5" /> },
  { name: "Mes livraisons", path: "/delivery/livraisons", icon: <PaperPlaneIcon className="w-5 h-5" /> },
  { name: "Profil", path: "/delivery/profil", icon: <UserCircleIcon className="w-5 h-5" /> },
];
