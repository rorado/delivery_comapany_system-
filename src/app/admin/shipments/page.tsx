...
export default function ShipmentsPage() {
  ...
  const handleExportPDF = (shipment: Shipment) => {
    ...
    yPos += 7;
    doc.text("Date : " + shipment.createdAt + " " + shipment.createdAtTime, margin, yPos);
    yPos += 10;
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-500 dark:text-gray-400">
            Gérer et suivre toutes les expéditions et livraisons depuis cette page.
          </p>
        </div>
        <button
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 border-t border-gray-200 pt-4 dark:border-gray-700">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Date : {viewingShipment.createdAt} {viewingShipment.createdAtTime}
                </p>
              </div>
              <div>
                <h5 className="font-semibold text-gray-800 dark:text-white/90 mb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, status: e.target.value as Shipment["status"] })
                  }
